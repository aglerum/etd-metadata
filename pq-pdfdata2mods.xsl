...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Last updated: </xd:b>October, 13 2019</xd:p>
    ...
    <xsl:variable name="pdfdata" select="document('source_pdfdata/2019Su/source_pdfdata_2019Su_corrected_w_uri_dept.xml')/records/record"/>
    <xsl:variable name="committee" select="document('modules/tables/ETD-NAF_mads_20191214.xml')/mads:madsCollection/mads:mads/mads:authority"/>
    <xsl:variable name="authors" select="document('modules/tables/authors_2019Su.xml')/authors/name"/>
    ...
    <xsl:variable name="degrees-PQ" select="document('modules/tables/degrees-PQ.xml')/degrees/degree"/>

    <xd:doc scope="template">
        <xd:desc>
            <xd:p><xd:b>Title: </xd:b>ProQuest and PDFdata to MODS</xd:p>
        </xd:desc>
    </xd:doc>
