...
<xsl:stylesheet version="2.0" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xsl:variable name="committee"
        select="document('tables/ETD-NAF_mads_20221011.xml')/mads:madsCollection/mads:mads/mads:authority"/>
    <xsl:variable name="authors"
        select="document('tables/authors_2020SuFa_2021Sp.xml')/authors/name"/>
            ...
            <xsl:for-each select="DISS_submission">
                ...
                <marc:record>
                    ...
                    <marc:datafield tag="856" ind1="4" ind2="0">
                        <xsl:variable name="semester">
                            <xsl:text>Spring_2022_</xsl:text>
                        </xsl:variable>
