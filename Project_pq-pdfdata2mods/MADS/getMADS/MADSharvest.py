...
in_file = open('source/2022Su_getMADS.txt', 'r')  # create and open a file object. the 'r' flag is for read

with open('result/2022Su_MADS.xml', 'w') as out_file:  # create another file object, this time in
    # 'w'=write mode
