...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p><xd:b>Last updated: </xd:b>October 14, 2019</xd:p>
    ...
    <xsl:variable name="header" select="'2019 Summer ETDs'"/>
    
    <xd:doc scope="template">
        <xd:desc>
            <xd:p><xd:b>Title: </xd:b>MODS to HTML Transformation</xd:p>
        </xd:desc>
    </xd:doc>
            ...
            <body>
                <div id="container">
                    ...
                    <xsl:for-each select="mods:mods">
                        ...
                        <xsl:for-each select="mods:note[position() gt 2]">
                            <p>
                                <span class="label">
