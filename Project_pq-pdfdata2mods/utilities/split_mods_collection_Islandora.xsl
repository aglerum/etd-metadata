    ...
    <xsl:template match="/">
        <xsl:for-each select="modsCollection/mods">
            ...
            <xsl:for-each select=".[note[@displayLabel = 'embargo'] = 0]">
                <xsl:result-document href="file:/C:/Users/achisum.FSU/OneDrive%20-%20Florida%20State%20University/Documents/GitHub/etd-metadata/Project_pq-pdfdata2mods/MODS/split_mods_Islandora/2021Su/mods_not_embargoed/{$filename}">
            ...
            <xsl:for-each select=".[note[@displayLabel = 'embargo'] != 0]">
                <xsl:result-document href="file:/C:/Users/achisum.FSU/OneDrive%20-%20Florida%20State%20University/Documents/GitHub/etd-metadata/Project_pq-pdfdata2mods/MODS/split_mods_Islandora/2021Su/mods_embargoed/{$filename}">
                    <mods:mods xmlns="http://www.loc.gov/mods/v3" xmlns:flvc="info:flvc/manifest/v1" xmlns:dcterms="http://purl.org/dc/terms/"
                        xmlns:etd="http://www.ndltd.org/standards/metadata/etdms/1.0/" xmlns:mods="http://www.loc.gov/mods/v3"
                        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/1999/xlink"
                        xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-6.xsd" version="3.6">
