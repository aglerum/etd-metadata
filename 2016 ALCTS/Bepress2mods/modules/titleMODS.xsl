    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b>Title: </xd:b>Template to split other title information from title
                proper</xd:p>
            <xd:p>This template is called by trans2mods.xsl. It splits other title information from
                title at ":" or "?" into mods:subTitle and articles into mods:nonSort.</xd:p>
            <xd:p>Acknowledgement: This template was adapted from SplitTitleabc by Shawn Averkamp
                and Joanna Lee.</xd:p>
        </xd:desc>
    </xd:doc>
